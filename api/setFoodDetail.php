...
<?php
    header('Access-Control-Allow-Origin:*');
	require_once("models/connection_pdo.php");

     if(isset($_GET['id_isla']) && isset($_GET['food_name']) && isset($_GET['food_weight']) && isset($_GET['status'])){
        $connection = getConnection();
        $query = "INSERT INTO food_detail(id_isla, food_name, food_weight, status) VALUES (?,?,?,?)";;
...
>>>>>>> 563e63e60aed1808c29a7926cf78a3e81338c734
?>